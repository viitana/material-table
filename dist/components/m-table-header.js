        ...
        if (columnDef.sorting !== false && _this.props.sorting) {
          ...
          content = React.createElement(_TableSortLabel["default"], {
            ...
            onClick: function onClick() {
              var orderDirection = ordering === undefined ? 'asc' : direction === 'asc' ? 'desc' : direction === 'desc' ? '' : direction === '' ? 'asc' : 'desc';

              _this.props.onOrderChange(columnDef.tableData.id, orderDirection);
            }
          }, content, "\xA0", ordering && _this.props.multiColumnSorting ? "(".concat(_this.props.orderBy.indexOf(ordering) + 1, ")") : '');
        }
